...
class Computation(object):
    ...
    def get_form(cls):
        ...
        """
        return {'thickness': {'default':Inversion.thickness,
                              'units':'&Aring;',
                              'type':'float',
                              'nullable':False,
                              'help':'Film thickness'},
                'substrate': {'default':Inversion.substrate,
                              'units':'&Aring;<span class="exponent">-2</span>',
                              'type':'float',
                              'nullable':True,
                              'help':'Substrate Scattering Length Density'},
                'rhopoints': {'default':Inversion.rhopoints,
                              'units':'',
                              'type':'int',
                              'nullable':True,
